                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <img src="success.gif" alt="Number of employee" width="300" height="300">
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;"> Employee </div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <img src="sales.gif" alt="Number of employee" width="300" height="300">
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;"> Sales </div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <img src="warehouse.gif" alt="Number of employee" width="300" height="300">
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;"> Production </div>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <img src="customer.gif" alt="Number of employee" width="300" height="300">
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;"> Customer </div>
                                        </div>
                                    </div>
                            </div>
                        </div>
